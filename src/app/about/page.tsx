    ...
    <section className="bg-gray-900">
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
          ...
          <div className="mt-8 sm:mt-12">
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="flex flex-col rounded-lg bg-teal-50 px-4 py-8 text-center">
                <dt className="order-last text-lg font-medium text-teal-500">
                  Total Sales
                </dt>
      ...
      <section className="bg-gray-900">
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <h2 className="text-center text-4xl font-bold tracking-tight text-teal-500 sm:text-5xl">
