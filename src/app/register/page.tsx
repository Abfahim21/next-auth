...
import bgImage from "../../../public/reg.jpg";
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-white shadow-sm p-2"
                  />
                </div>
                ...
                <div className="col-span-6">
                  <p className="text-sm text-white">
                    ...
                    <a href="#" className="text-white underline px-1">
